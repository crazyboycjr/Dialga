 ...
 */
#ifndef PARAEXPRESS_INTERNAL_SARRAY_H_
#define PARAEXPRESS_INTERNAL_SARRAY_H_
#include <string.h>
#include <memory>
#include <sstream>
#include <string>
 ...
 */
template <typename V, typename Allocator = SmartAllocator<V>>
class SArray {
 public:
...
#endif  // PARAEXPRESS_INTERNAL_SARRAY_H_
